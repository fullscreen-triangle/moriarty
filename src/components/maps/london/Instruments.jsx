  ...
  export default function Instruments() {
    return (
      <div className="bg-black">
        <div className="mx-auto grid max-w-2xl grid-cols-1 items-center text-white gap-x-8 gap-y-16 px-4 py-24 sm:px-6 sm:py-32 lg:max-w-7xl lg:grid-cols-2 lg:px-8">
          <div>
